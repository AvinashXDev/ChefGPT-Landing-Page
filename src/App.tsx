    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-gray-100">
      ...
      <nav
        className={`fixed w-full z-50 transition-all duration-300 ${
          scrolled ? "bg-gray-900/95 backdrop-blur-lg shadow-lg" : ""
        }`}
      >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-8">
              <div className="flex items-center">
                ...
                <a href="#home">
                  <span className="ml-2 text-xl font-bold bg-gradient-to-r from-white via-emerald-200 to-emerald-400 text-transparent bg-clip-text">
                    ChefGPT
                  </span>
                </a>
              </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <a href="https://chefgpt-yopb.vercel.app/">
                {" "}
          ...
          <div className="text-center">
            ...
            >
              <div className="relative">
                <ChefHat
                  className={`w-16 h-16 text-emerald-400 transition-all duration-300 ${
                    isHovered ? "rotate-12 scale-110" : ""
                  }`}
                />
                <Sparkles
                  className={`absolute -right-2 -top-2 w-8 h-8 text-emerald-400 transition-all duration-300 ${
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8 animate-slide-up leading-relaxed">
              Your AI-powered culinary companion. Transform ingredients into
              extraordinary recipes with the power of artificial intelligence.
            </p>
      ...
      >
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Experience the future of cooking with our advanced AI-powered
            features.
          </p>
        </div>
          ...
          <div className="relative bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 p-12 rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto text-center text-lg">
                Join thousands of home chefs who are already creating amazing
                dishes with ChefGPT. Start your culinary journey today!
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8 border-t border-gray-800">
            <p className="text-gray-500 text-sm">
              © 2024 ChefGPT. Made with 💗 by Avinash
            </p>
...
function FeatureCard({
  ...
  return (
    <div
      className={`group bg-gray-800/50 backdrop-blur-lg p-8 rounded-xl border border-gray-700 hover:border-emerald-500/50 transition-all duration-500 hover:scale-105 hover:shadow-xl hover:shadow-emerald-500/10 animate-fade-in ${delay}`}
    >
